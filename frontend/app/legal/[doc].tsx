...
const DOCS: Record<string, { title: string; sections: { h: string; b: string }[] }> = {
  terms: {
    ...
    sections: [
      ...
      { h: "Termination", b: "You can delete your account at any time in Settings. We may suspend or terminate accounts that violate these Terms." },
      { h: "Changes", b: "We may update these Terms; continued use means you accept the changes." },
    ],
  },
  privacy: {
