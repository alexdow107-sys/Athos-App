...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 64, height: 64, borderRadius: 32, backgroundColor: "#FEF3C7", alignItems: "center", justifyContent: "center" },
  ...
  priceCard: { backgroundColor: colors.text, padding: spacing.lg, borderRadius: radius.xl, marginBottom: spacing.xl },
