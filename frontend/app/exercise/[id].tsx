...
const styles = StyleSheet.create({
  ...
  imbalanceCard: { flexDirection: "row", margin: spacing.md, padding: spacing.md, backgroundColor: "rgba(192,64,64,0.10)", borderWidth: 1, borderColor: "rgba(192,64,64,0.28)", borderRadius: radius.lg, alignItems: "flex-start" },
